...
uint64 PINConverter::convertTritonReg2DBIReg(uint64 regID) {
	switch (regID){
	case ID_RAX:    return REG_EAX;
	case ID_RBX:    return REG_EBX;
	case ID_RCX:    return REG_ECX;
	case ID_RDX:    return REG_EDX;
	case ID_RDI:    return REG_EDI;
	case ID_RSI:    return REG_ESI;
	case ID_RBP:    return REG_EBP;
	case ID_RSP:    return REG_ESP;
	case ID_RIP:    return REG_EIP;
	case ID_RFLAGS: return REG_EFLAGS;
	case ID_XMM0:   return REG_XMM0;
	case ID_XMM1:   return REG_XMM1;
	case ID_XMM2:   return REG_XMM2;
	case ID_XMM3:   return REG_XMM3;
...
std::string PINConverter::getRegisterName(uint64 regID) {
	switch (regID){
	case ID_RAX:    return "eax";
	case ID_RBX:    return "ebx";
	case ID_RCX:    return "ecx";
	case ID_RDX:    return "edx";
	case ID_RDI:    return "edi";
	case ID_RSI:    return "esi";
	case ID_RBP:    return "ebp";
	case ID_RSP:    return "esp";
	case ID_RIP:    return "rip";
	case ID_R8:     return "r8";
	case ID_R9:     return "r9";
	case ID_R10:    return "r10";
